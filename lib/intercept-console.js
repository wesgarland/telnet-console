...
exports.ConsoleInterceptor = function ConsoleInterceptor(options)
{
  ...
  function wrapperFactory(level)
  {
    function consoleWrapper()
    {
      ...
      {
        this.underlyingConsoleMethods.error.call(this.underlyingConsoleThis, 'Uncaught Error in consoleWrapper', e);
      }

      return this.underlyingConsoleMethods[level].apply(this.underlyingConsoleThis, arguments);
    }
  ...
  for (let level of this.levels)
    this.underlyingConsoleThis = this[level] = wrapperFactory(level);
  ...
  function traceWrapper()
  {
    ...
    this.underlyingConsoleMethods.trace.apply(this.underlyingConsoleThis, arguments);
  }
